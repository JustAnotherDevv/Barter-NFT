...
export interface FakeNFTCollectionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface FakeNFTCollection extends BaseContract {
  connect(runner?: ContractRunner | null): FakeNFTCollection;
  waitForDeployment(): Promise<this>;

  interface: FakeNFTCollectionInterface;
  ...
  batchMintTo: TypedContractMethod<
    [recipients: AddressLike[], quantities: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  getTokensOf: TypedContractMethod<[owner: AddressLike], [bigint[]], "view">;
